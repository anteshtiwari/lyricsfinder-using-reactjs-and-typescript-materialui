...
class Search extends Component {
  ...
  findTrack = (dispatch, e) => {
    ...
    axios.get('https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.search?q_artist=${this.state.trackTitle}&page_size=10&page=1&s_track_rating=descapikey=${process.env.REACT_APP_MM_KEY}')
      .then(res => {
